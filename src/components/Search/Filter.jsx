...
import { ProfetionContext } from "./SearchTab";
import CustomCountryBox from "./CustomCountryBox";

const Filter = () => {
  const profetion = useContext(ProfetionContext);
  ...
  console.log("selecteCountry",selecteCountry);
  ...
  return (
    <div>
      <div className="font-bold sm:text-2xl text-lg mb-3">
        Filter options for <span className="text-[#FFA500]">"{profetion}"</span>{" "}
        services
      </div>
      ...
      <div className="flex flex-wrap justify-between mb-4">
        <div className="overflow-x-auto flex scrollbar gap-3 text-nowrap 	">
          ...
          <CustomCountryBox
            ...
            selectedOptions={selecteCountry}
            setSelectedOptions={setselecteCountry}
