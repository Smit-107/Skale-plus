    ...
    <React.Fragment>
     <div className="container md:pb-20 lg:pb-24 pb-10">
        <div className="mx-4 sm:mx-10 flex flex-col gap-12 md:gap-28 ">
          <div className="flex flex-col font-Poppins text-[48px] font-bold text-[#000] text-center gap-4 lg:gap-4">
            <span className="font-Montserrat text-[30px] md:text-[30px] lg:text-[48px] font-bold p-[10px] sm:p-0">
              About
            </span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 ">
            ...
            <div className="flex flex-col gap-7 text-start ">
              <div className="flex flex-col gap-2 text-[#000] ">
                <span className="text-[22px] sm:text-[24px] font-Montserrat font-bold">
                  Sed ut perspiciatis
                </span>
                <span className="text-[14px] md:text-[16px] lg:text-[18px] text-[#00000088] font-Montserrat ">
